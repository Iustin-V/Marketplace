    ...
    return (
        <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4 top-20 relative">
            <div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
                ...
                <img className="mt-6 w-full" alt="img of a girl posing" src={src} />
            </div>
            <div className="md:hidden">
                <img className="w-full" alt="img of a girl posing" src={listingData.imagine} />
...
Contacteaza vanzatorul                </button>
                <div>
                    <p className="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 mt-7">{listingData.descriere}</p>
                    <p className="text-base leading-4 mt-7 text-gray-600">Data adaugare: {listingData.data.slice(0,10)}</p>
