					...
					"
                        ...
                        <div className={"pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 " + (show3 ? "block" : "hidden")} id="sect">
                            ...
                            <div className="py-4 border-b border-gray-200 flex items-center justify-between ">
                                ...
                                <div className="flex items-center justify-center cursor-pointer" onClick={()=>window.open(`https://wa.me/${"profile.telefon"}?text=Salut%2C%0D%0A%0D%0ASunt+interesat+de+produsul+t%C4%83u.+Po%C8%9Bi+oferi+mai+multe+detalii%3F`)}>
